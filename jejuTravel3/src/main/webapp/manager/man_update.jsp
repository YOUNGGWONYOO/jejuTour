                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="form" action="updateUser_confirm.do" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="password" class="form-control" name="m_pw" id="input1" value="${mem_de.m_pw}">
                                        </div>
                                    </div>  
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-6">
                                            ...
                                            <input type="button" class="btn btn-active" value="재작성" onclick="location.reload()">&nbsp;&nbsp;&nbsp;
             							    <input type="button" class="btn btn-warning" value="취소" onclick="location.href='detail.do?m_id=${mem.m_id}'">
                                        </div>
                                    </div>
