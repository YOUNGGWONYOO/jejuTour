                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="form" action="qnaWrite.do" method="post">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">제목</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="q_subject" id="input2">
                                        </div>
                                    </div>        
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">내용</label>
                                        <div class="col-sm-6">                                      
                                            <pre><textarea class="form-control" rows="20" cols="50" name="q_content"></textarea></pre>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-6">	    
             							     <input type="submit" class="btn btn-primary" value="확인">&nbsp;&nbsp;&nbsp;
              								 ...
              								 <input type="button" class="btn btn-warning" value="취소" onclick="location.href='qna.do'">
                                        </div>
                                    </div>
