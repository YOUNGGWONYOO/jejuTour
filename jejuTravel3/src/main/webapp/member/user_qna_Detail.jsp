...
<section id="main-content" class="animated fadeInUp" style="width:1200px;margin:0 auto;">
						...
						<form class="form-horizontal form-border" id="form">
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-6">
								  <c:if test="${sessionScope.m_id == qna.m_id}">
									<input type="button" class="btn btn-primary" value="QnA수정"
										onclick="location.href='qnaUpdate.do?q_seq=${qna.q_seq}&m_id=${qna.m_id}'">&nbsp;&nbsp;&nbsp;
									<input type="button" class="btn btn-warning" value="뒤로가기"
										onclick="location.href='qna.do'">&nbsp;&nbsp;&nbsp; 
										<input type="button" class="btn btn-danger" value="삭제"
										onclick="location.href='qnaDelete.do?q_seq=${qna.q_seq}&m_id=${qna.m_id}'">
									</c:if>
									<c:if test="${sessionScope.m_id != qna.m_id}">
										<input type="button" class="btn btn-warning" value="뒤로가기"
										onclick="location.href='qna.do'">&nbsp;&nbsp;&nbsp;
	...
	<div class="panel-body" style="width:1260px;margin:0 auto;">
		...
		<form class="form-horizontal form-border" action="insertReply.do"
			method="post">
			<div class="form-group">
				<label class="col-sm-3 control-label">댓글:</label>&nbsp; <input
					type="text" class="col-sm-6" name="re_content">&nbsp; <input
					class="btn btn-success" type="submit" value="작성">
			</div>
							...
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-6">
								  ...
								  <c:choose>
								  	...
								  	<c:when test="${sessionScope.m_id eq r.m_id}">
								  		<input type="button" class="btn btn-danger" value="삭제"
										onclick="location.href='deleteReply.do?re_seq=${r.re_seq}&m_id=${r.m_id}&q_seq=${qna.q_seq}&s_m_id=${sessionScope.m_id}'">
								  	</c:when>
								  </c:choose>
								</div>
							</div>
