                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="form" action="updateUser_confirm.do" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="password" class="form-control" name="m_pw" id="input2" value="${mem_de.m_pw}">
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">이름</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="m_name" id="input2" value="${mem.m_name}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">이메일</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control"  name="m_email"  id="input3" value="${mem.m_email}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">전화번호</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="m_phone"  id="input4" value="${mem.m_phone}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-6">
                                            ...
                                            <input type="button" class="btn btn-active" value="재작성" onclick="location.reload()">&nbsp;&nbsp;&nbsp;
             							    <input type="button" class="btn btn-warning" value="취소" onclick="location.href='viewUser.do?m_id=${mem.m_id}'">
                                        </div>
                                    </div>
