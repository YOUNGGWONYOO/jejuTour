...
<script>
	function deleteId(){
		 if(confirm('아이디가 삭제됩니다. 삭제하시겠습니까?')==true){
			 location.href='deleteUser.do?m_id=${sessionScope.m_id}'
		 }else{
			 return false;
		 }
	}
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="form" action="updateUser.do" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-6">
                                            <input type="submit" class="btn btn-info" value="회원수정">&nbsp;&nbsp;&nbsp;
             								<input type="button" class="btn btn-primary" value="홈" onclick="location.href='<%=location%>/search/main.do'">&nbsp;&nbsp;&nbsp;
             								<input type="button" class="btn btn-danger" value="회원탈퇴" onclick="deleteId()">
                                        </div>
                                    </div>
